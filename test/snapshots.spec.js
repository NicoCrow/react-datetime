...
const date = () => moment('2016-12-21T23:36:07.071Z');
...
it('value: set to arbitrary value', () => {
    const tree = renderer.create(
        <Datetime defaultValue={moment('2016-12-21T23:36:07.071Z')} />
    ).toJSON();
    expect(tree).toMatchSnapshot();
});
...
describe('dateFormat', () => {
    it('set to true', () => {
        const tree = renderer.create(
            <Datetime dateFormat={true} value={moment('2016-12-21T23:36:07.071Z')}/>
        ).toJSON();
        expect(tree).toMatchSnapshot();
    });
    ...
    it('set to false', () => {
        const tree = renderer.create(
            <Datetime dateFormat={false} value={moment('2016-12-21T23:36:07.071Z')} />
        ).toJSON();
        expect(tree).toMatchSnapshot();
    });
});
